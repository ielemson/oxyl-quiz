...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="{{url('/')}}" class="logo" title="{{$setting->welcome_txt}}">
      ...
      <span class="logo-lg">
        @if ($setting)
        <img src="{{asset('/images/logo/'.$setting->logo)}}" class="ad-logo img-responsive" alt="{{$setting->welcome_txt}}" style="width:100%;">
        @endif
      </span>
    </a>
    <!-- Header Navbar -->
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        @if ($auth->role == 'A')
          ...
          <li class="{{$quiz}}"><a href="{{url('admin/topics')}}" title="Course"><i class="fa fa-gears"></i> <span>Courses</span></a></li>          
